...
import 'package:music_and_art_admin_panel/viewModel/age_group_view_model.dart';
...
class _AgeGroupScreenState extends State<AgeGroupScreen> {
  @override
  void initState() {
    ageGroupViewModel.getCategoriesList();
    super.initState();
  }

  AgeGroupViewModel ageGroupViewModel = Get.put(AgeGroupViewModel());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<AgeGroupViewModel>(
        builder: (controller) {
          return Container(
            height: height,
            width: width,
      ...
      builder: (context) {
        return StatefulBuilder(
          builder:
            ...
            return GetBuilder<AgeGroupViewModel>(
              builder: (controller) {
                return Scaffold(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton(
                                        ...
                                        onChanged: (dynamic val) {
                                          ...
                                          log('MESSAGE ;- ${controller.selectedCategory}');
                                        },
                                      ),
                                    ),
                                  ),
